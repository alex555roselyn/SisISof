...
export default class ListarProductosInfo extends React.Component {
 constructor(props) {
    super(props);
...
<Text>{datagrid[i]._source.name} Cantidad {datagrid[i]._source.existencia}  Precio Q.{datagrid[i]._source.precio}___________________________________________________</Text>
...
<Document title="Factura Contable">
 ...
 <View style={{
  ...
  <Text style={{textAlign: 'center'}}>Spring Cleaning inc.</Text>
     <Text style={{textAlign: 'center'}}>Informe de Productos</Text>
