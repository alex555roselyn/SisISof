  ...
  render() {
    return (
          ...
          <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
           ...
           INICIO
            ...
            <SubMenu key="sub2" icon={<ShoppingCartOutlined />} title="Pedidos">
              <Menu.Item key="5" icon={<OrderedListOutlined />}>Ordenes<Link to="/ordenes" /></Menu.Item>
              <Menu.Item key="6" icon={<EditOutlined />}>Nuevo<Link to="/ordenes&nuevo" /></Menu.Item>
              <Menu.Item key="7" icon={<ExpandAltOutlined />}>Graficas<Link to="/graficas" /></Menu.Item>
            </SubMenu>
              ...
              <Menu.Item key="9" icon={<EditOutlined />}>Nuevo<Link to="/clientes&nuevo" /></Menu.Item>
                <Menu.Item key="10" icon={<FormOutlined />}>Modificar<Link to="/modificar&clientes" /></Menu.Item>
            </SubMenu>
     ...
     <Route exact path="/" component={Dashboard} />
      ...
      <Route path="/listar&prod" component={Listar} />
       <Route path="/ordenes&nuevo" component={OrdenesCompra} />
         <Route path="/informe&ventas" component={RenderPDF} />
