...
export default class ListarClientesInfo extends React.Component {
 constructor(props) {
    super(props);
...
<Text>{datagrid[i]._source.nombre} {datagrid[i]._source.apellido} {datagrid[i]._source.telefono} {datagrid[i]._source.correo}   {tg}</Text>
...
<Document title="Factura Contable">
 ...
 <View style={{
  ...
  <Text style={{textAlign: 'center'}}>Spring Cleaning inc.</Text>
     <Text style={{textAlign: 'center'}}>Informe de Clientes</Text>
      ...
      <Text>Clientes</Text>
           <Text>___________________________________________________</Text>
            <Text>Nombre                Telefono      Correo                          Estado</Text>
       {data}
            <Text>___________________________________________________</Text>
